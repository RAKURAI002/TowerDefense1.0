...
public class CannonTurret : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        cannonPart.rotation = Quaternion.Euler(0f, 0f, rotation - 90);
    ...
    void shoot()
    {
        GameObject bullet = Instantiate(cannonShell, firePos.position, firePos.rotation);
       // Debug.Log("Instantiate to : " + firePos.position);
        Shell cs = bullet.GetComponent<Shell>();
        cs.setTarget(target);
    }
    void EnemyTrack()
    {
